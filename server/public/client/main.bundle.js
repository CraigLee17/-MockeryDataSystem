...
var Field = (function () {
    function Field(fieldName, dateTypeName, _id, option, blank, outlier, fb) {
    ...
    Field.prototype.buildField = function () {
        return this.fb.group({
            ...
            blank: [
                this.blank,
                [__WEBPACK_IMPORTED_MODULE_0__angular_forms__["g" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_0__angular_forms__["g" /* Validators */].pattern("^([0-9]|([1-9][0-9])|100)$")],
            ],
            outlier: [
                this.outlier,
                [__WEBPACK_IMPORTED_MODULE_0__angular_forms__["g" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_0__angular_forms__["g" /* Validators */].pattern("^([0-9]|([1-9][0-9])|100)$")],
...
var CreateSchemaComponent = (function () {
    function CreateSchemaComponent(sessionService, fb, dataTypeService, schemaService, router) {
        ...
        this.dataTypeService
            .getAllDataTypes()
            .subscribe(function (dataTypes) { return _this.categorizeTypes(dataTypes); });
    }
    CreateSchemaComponent.prototype.categorizeTypes = function (dataTypes) {
        for (var index in this.category) {
            ...
            this.dataTypes[kind] = dataTypes
                .filter(function (type) { return type.name.startsWith(kind); })
                .map(function (type) {
                type.name = type.name
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        fieldGroup = fields.map(function (field) {
                            return new __WEBPACK_IMPORTED_MODULE_8__models_field__["a" /* Field */](field.name, field.dataType.name, field.dataType._id, field.option, field.blank, field.outlier, _this.fb).buildField();
                        });
    ...
    CreateSchemaComponent.prototype.addField = function () {
        ...
        var newField = new __WEBPACK_IMPORTED_MODULE_8__models_field__["a" /* Field */]("New" + lastField.value.name, lastField.value.dataType.name, lastField.value.dataType._id, "", 0, 0, this.fb).buildField();
    ...
    CreateSchemaComponent.prototype.createSchema = function (newSchema) {
        ...
        if (!this.checkFieldName(newSchema.fields))
            return;
        this.schemaService.create(newSchema).subscribe(function (data) {
            return _this.router.navigate([
                "/user",
                _this.sessionService.getUser().id,
                "schemas",
            ]);
        }, function (error) { return (_this.schemaError = error.error.text); });
    };
...
var UpdateSchemaComponent = (function () {
    ...
    UpdateSchemaComponent.prototype.buildFields = function () {
        var _this = this;
        var fields = this.schema.fields.map(function (field) {
            return new __WEBPACK_IMPORTED_MODULE_7__models_field__["a" /* Field */](field.name, field.dataType.name, field.dataType._id, field.option, field.blank, field.outlier, _this.fb).buildField();
        });
    ...
    UpdateSchemaComponent.prototype.addField = function () {
        var fields = this.updateSchemaForm.controls["fields"];
        var lastField = this.buildField();
        var newField = new __WEBPACK_IMPORTED_MODULE_7__models_field__["a" /* Field */]("New" + lastField.value.name, lastField.value.dataType.name, lastField.value.dataType._id, "", 0, 0, this.fb).buildField();
        fields.push(newField);
    };
    ...
    UpdateSchemaComponent.prototype.updateSchema = function (updateSchema) {
        ...
        if (this.sessionService.getUser().id != this.schema.user) {
            ...
            if (confirm("Are you sure to change it? Mock data related with this old schema will be removed!")) {
                ...
                this.schemaService.update(updateSchema).subscribe(function (schema) {
                    return _this.router.navigate([
                        "/users",
                        _this.sessionService.getUser().id,
                        "schemas",
